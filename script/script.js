...
const copiaDiIngredienti = ingredienti.slice();
...
console.log(copiaDiIngredienti);
...
const numbers = [23, 44, 50, 90, 13, 7];

const numbersSaquare = [];
for (let i = 0; i < numbers.length; i++) {
  const numSquare = numbers[i] * numbers[i];

  numbersSaquare.push(numSquare);
}
